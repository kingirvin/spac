...
<head>
   ...
   <title>Plan Docente</title>
    ...
    <link href="{{ asset('libs/datatables/css/dataTables.bootstrap4.css') }}" rel="stylesheet"> @yield('css')
</head>
        ...
        <header class="navbar navbar-expand-md navbar-light d-print-none">
            <div class="container-xl">
                ...
                <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                    <a href=".">
                        <img src="./static/logo.svg" width="110" height="32" alt="Plan Docente 2022" class="navbar-brand-image">
                    </a>
                </h1>
                <div class="navbar-nav flex-row order-md-last">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    natus odio quidem quod repudiandae sapiente. Amet debitis et magni maxime necessitatibus
                                    ullam.
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                            <span class="avatar bg-green-lt">{{$user->avatar}}</span>
                            <div class="d-none d-xl-block ps-2">
                                ...
                                @else
                                    ...
                                    @else
                                    <div class="mt-1 small text-muted">Alumno</div>
                                    @endif
                                @endif
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                        ...
                        <a href="#" class="dropdown-item">Mis archivos</a>
                        <a href="#" class="dropdown-item">Cambiar contraseña</a>
                        <a href="#" class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();  document.getElementById('logout-form').submit();"> Cerrar sesión</a>
                    ...
                    <div class="container-xl">
                        <ul class="navbar-nav">
                            @foreach($modulos as $modulo)   
                                ...
                                @else
                                    <li class="nav-item {{$activo=='Usuario' ? 'active':''}}">
                                        <a class="nav-link" href="{{url('/administracion/usuarios')}}">
                            ...
                            <ul class="list-inline list-inline-dots mb-0">
                                ...
                                <li class="list-inline-item">
                                    <a href="https://github.com/sponsors/codecalm" target="_blank" class="link-secondary" rel="noopener">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon text-pink icon-filled icon-inline" width="24" height="24" viewBox="0 0 24 24"
